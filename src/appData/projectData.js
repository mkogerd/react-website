...
const PROJECT_DATA = [
  {
    ...
    summary:
      'I spent a year working at Stripe on the issuing team. Some highlights of this were building out the Issuing Tokens API from scratch and improving monitoring, servicing, and reliability for Stripe Issuing disputes.',
  ...
  },
  {
    name: 'Indeed Hire',
    description:
      'Recruiting services focused on helping employers manage hiring from start to finish.',
    summary:
      'I worked on Indeed Hire for almost 2 years. During this time, I maintained and augmented in-house recruiting software, including working with product members to design and implement new features for managing 40k+ daily applicants.',
  ...
  },
  {
    ...
    description:
      'Online multiplayer game implementing 2D gravity physics created with html canvas, javascript, and node.js.',
    summary:
      'This is an online multiplayer "io" game implementing 2D gravity physics created with html canvas, javascript, and node.js. The networking is handled using a custom binary messaging protocol built on top of WebSockets.',
  ...
  },
  {
    ...
    description:
      'Motion tracking and video extraction from a still camera frame.',
    summary:
      'This was a project for my image processing class. The idea came from another one of my projects where I wanted to cut down on the blank space in some dance videos. It uses MATLAB and basic image processing filters.',
    ...
    demoLink:
      'https://github.com/mkogerd/EE371R-Motion-Tracking/blob/master/Darden(mkd788)_project_report.pdf',
  },
  {
